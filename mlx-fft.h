...
public:
    ...
    std::shared_ptr<MlxDoubleVector> normalizedMagnitude(const MlxDoubleVector &signal);

    std::shared_ptr<MlxDoubleVector> pwrSpectralDensity(const MlxDoubleVector &signal, const double fs, const double df);
